...
public class quiz extends JFrame implements ActionListener{
    ...
    quiz(String name)
    {
        ...
        image.setBounds(0,0, 1300, 325);
        add(image);

         que = new JLabel();
        que.setBounds(100,380,50,30);
        que.setFont(new Font("Tahoma",Font.PLAIN,18));
        add(que);

        question = new JLabel();
        question.setBounds(130,380,900,30);
        question.setFont(new Font("Tahoma",Font.PLAIN,18));
        add(question);

        setBounds(50, 25, 1300,700);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        ...
        next.setBounds(1000, 450, 200, 30);
        ...
        Lifeline.setBounds(1000, 510, 200, 30);
        Lifeline.setBackground(Color.BLUE);
        Lifeline.setFont(new Font("Times new roman",Font.PLAIN,18));
        Lifeline.setForeground(Color.WHITE);
        Lifeline.addActionListener(this);
        add( Lifeline);

        Submit = new JButton("Submit");
        Submit.setBounds(1000, 570, 200, 30);
    ...
    public void paint(Graphics g){
        ...
        if(timer>0){
            g.drawString(time, 1010, 420);
        }else{
            g.drawString("time's up!!", 1010, 420);
        }
        timer--;
